...
export default function Education() {
  const education = [
    {
      degree: "Bachelor of Fine Arts in Visual Arts",
      institution: "Azerbaijan State Academy of Fine Arts",
      period: "2019 – 2023",
      location: "Baku, Azerbaijan",
      achievements: [
        "Specialized in various visual art techniques and mediums",
        "Developed a strong foundation in art history and theory",
        "Participated in numerous student exhibitions and projects",
      ],
    },
  ]
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSectionHeader title="Educational Background" />
