...
const contactInfo = [
  {
    ...
    content: "aydan.a.ali@gmaill.com",
    href: "mailto:aydan.a.ali@gmaill.com",
  },
  {
    icon: <Phone className="w-6 h-6 mr-3 text-blue-600" />,
    content: "+994519806637",
    href: "tel:+994519806637",
  },
  {
    icon: <MapPin className="w-6 h-6 mr-3 text-blue-600" />,
